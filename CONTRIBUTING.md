...
|Table of contents|
|:----------------|
| 1. Setting up the development environment<br>%20- [Setting up for WinCLI](#WinCLI-Setup)<br>   - [Setting up for WinGUI](#WinGUI-Setup)  - [Setting up for Android](#Android-Setup)|
